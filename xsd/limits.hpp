...
namespace openstack
{
  ...
  {
    /**
     * @brief Class corresponding to the %limits root element.
     *
     * @nosubgrouping
     */
    class Limits_: public ::xml_schema::ElementType
    {
      public:
       ...
       */
      typedef ::openstack::xml::Limits ValueType;
       ...
       */
      Limits_ (const ::xercesc::DOMElement& e, ::xml_schema::Flags f = 0);
       ...
       */
      Limits_ (const Limits_& x, ::xml_schema::Flags f = 0);
