...
namespace openstack
{
  ...
  {
    /**
     * @brief Class corresponding to the %image root element.
     *
     * @nosubgrouping
     */
    class Image_: public ::xml_schema::ElementType
    {
      public:
       ...
       */
      typedef ::openstack::xml::Image ValueType;
       ...
       */
      Image_ (const ::xercesc::DOMElement& e, ::xml_schema::Flags f = 0);
       ...
       */
      Image_ (const Image_& x, ::xml_schema::Flags f = 0);
    ...
    /**
     * @brief Class corresponding to the %images root element.
     *
     * @nosubgrouping
     */
    class Images_: public ::xml_schema::ElementType
    {
      public:
       ...
       * @brief Element value type.
       */
      typedef ::openstack::xml::Images ValueType;
       ...
       * @param f Flags to create the new instance with.
       */
      Images_ (const ::xercesc::DOMElement& e, ::xml_schema::Flags f = 0);
       ...
       * For polymorphic object models use the @c _clone function instead.
       */
      Images_ (const Images_& x, ::xml_schema::Flags f = 0);
