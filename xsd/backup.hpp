...
namespace openstack
{
  ...
  {
    /**
     * @brief Class corresponding to the %backupSchedule root element.
     *
     * @nosubgrouping
     */
    class BackupSchedule_: public ::xml_schema::ElementType
    {
      public:
       ...
       */
      typedef ::openstack::xml::BackupSchedule ValueType;
       ...
       */
      BackupSchedule_ (const ::xercesc::DOMElement& e, ::xml_schema::Flags f = 0);
       ...
       */
      BackupSchedule_ (const BackupSchedule_& x, ::xml_schema::Flags f = 0);
