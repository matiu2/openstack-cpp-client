...
namespace openstack
{
  namespace xml
  {
    ...
    const ::xml_schema::Type* Limits_::
    _value () const
    {
      return &this->value_.get ();
    }

    ::xml_schema::Type* Limits_::
    _value ()
    {
      return &this->value_.get ();
    }
    ...
    Limits_::
    Limits_ (const ValueType& x)
    : value_ (x, 0, 0)
    {
    }

    Limits_::
    Limits_ (::std::auto_ptr< ValueType > p)
    : value_ (p, 0, 0)
    {
    }

    Limits_::
    Limits_ (const ::xercesc::DOMElement& e, ::xml_schema::Flags f)
    : value_ (f, 0)
    {
    ...
    Limits_::
    Limits_ (const Limits_& x, ::xml_schema::Flags f)
    ...
    {
      return new class Limits_ (*this, f);
    }

    const ::std::string& Limits_::
    name ()
    {
      return name_;
    }
    ...
    static 
    const ::xsd::cxx::tree::parser_init< Limits_, char, ::xml_schema::Type >
    _xsd_Limits__parser_init (Limits_::name (), Limits_::namespace_ ());
