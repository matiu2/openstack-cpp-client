...
/**
 * @file
 * @brief Generated from image.xsd.
 */

#ifndef XSDS_IMAGE_HPP
#define XSDS_IMAGE_HPP
...
namespace openstack
{
  ...
  namespace xml
  {
    ...
    class Image: public ::xml_schema::Type
    {
       ...
       * @name serverId
       *
       * @brief Accessor and modifier functions for the %serverId
       * optional attribute.
       */
      //@{
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::Int ServerIdType;

      /**
       * @brief Attribute optional container type.
       */
      typedef ::xsd::cxx::tree::optional< ServerIdType > ServerIdOptional;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< ServerIdType, char > ServerIdTraits;
       ...
       * @name updated
       *
       * @brief Accessor and modifier functions for the %updated
       * optional attribute.
       */
      //@{
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::DateTime UpdatedType;

      /**
       * @brief Attribute optional container type.
       */
      typedef ::xsd::cxx::tree::optional< UpdatedType > UpdatedOptional;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< UpdatedType, char > UpdatedTraits;
       ...
       */
      void
      updated (::std::auto_ptr< UpdatedType > p);
       ...
       * @name created
       *
       * @brief Accessor and modifier functions for the %created
       * optional attribute.
       */
      //@{
       ...
       * @brief Attribute type.
       */
      typedef ::xml_schema::DateTime CreatedType;

      /**
       * @brief Attribute optional container type.
       */
      typedef ::xsd::cxx::tree::optional< CreatedType > CreatedOptional;

      /**
       * @brief Attribute traits type.
       */
      typedef ::xsd::cxx::tree::traits< CreatedType, char > CreatedTraits;
       ...
       */
      void
      created (::std::auto_ptr< CreatedType > p);
       ...
       * @brief Attribute type.
       */
      typedef ::openstack::xml::ImageStatus StatusType;
      ...
      ServerIdOptional serverId_;
      UpdatedOptional updated_;
      CreatedOptional created_;
    ...
    class Images: public ::xml_schema::Type
    {
       ...
       * @brief Element type.
       */
      typedef ::openstack::xml::Image ImageType;

      /**
       * @brief Element sequence container type.
       */
      typedef ::xsd::cxx::tree::sequence< ImageType > ImageSequence;

      /**
       * @brief Element iterator type.
       */
      typedef ImageSequence::iterator ImageIterator;

      /**
       * @brief Element constant iterator type.
       */
      typedef ImageSequence::const_iterator ImageConstIterator;
      ...
      protected:
      ImageSequence image_;

      //@endcond
    };

    /**
     * @brief Enumeration class corresponding to the %ImageStatus
     * schema type.
     */
    class ImageStatus: public ::xml_schema::String
    {
      public:
       ...
       * For polymorphic object models use the @c _clone function instead.
       */
      ImageStatus (const ImageStatus& x,
                   ::xml_schema::Flags f = 0,
                   ::xml_schema::Container* c = 0);
      ...
      {
        return _xsd_ImageStatus_convert ();
      }
      ...
      public:
      static const char* const _xsd_ImageStatus_literals_[6];
      static const Value _xsd_ImageStatus_indexes_[6];
...
namespace openstack
{
  ...
  {
    /**
     * @name Parsing functions for the %image document root.
     */
    //@{
    ...
    /**
     * @name Parsing functions for the %images document root.
     */
    //@{
...
namespace openstack
{
  ...
  {
    /**
     * @name Serialization functions for the %image document root.
     */
    //@{
     ...
     */
    void
    image (::std::ostream& os,
           const ::openstack::xml::Image& x, 
     ...
     */
    void
    image (::xercesc::XMLFormatTarget& ft,
           const ::openstack::xml::Image& x, 
           const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
           const ::std::string& e = "UTF-8",
           ::xml_schema::Flags f = 0);
    ...
    image (const ::openstack::xml::Image& x, 
           const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
           ::xml_schema::Flags f = 0);
    ...
    /**
     * @name Serialization functions for the %images document root.
     */
    //@{
     ...
     */
    void
    images (::std::ostream& os,
            const ::openstack::xml::Images& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
     ...
     */
    void
    images (::xercesc::XMLFormatTarget& ft,
            const ::openstack::xml::Images& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
     ...
     */
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
    images (const ::openstack::xml::Images& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);
    ...
    void
    operator<< (::xercesc::DOMElement&, const Image&);

    void
    operator<< (::xercesc::DOMElement&, const Images&);

    void
    operator<< (::xercesc::DOMElement&, const ImageStatus&);

    void
    operator<< (::xercesc::DOMAttr&, const ImageStatus&);
