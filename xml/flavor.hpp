...
namespace openstack
{
  ...
  {
    /**
     * @name Parsing functions for the %flavor document root.
     */
    //@{
    ...
    /**
     * @name Parsing functions for the %flavors document root.
     */
    //@{
     ...
     */
    ::std::auto_ptr< ::openstack::xml::Flavors >
    flavors (::xercesc::InputSource& is,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
namespace openstack
{
  ...
  {
    /**
     * @name Serialization functions for the %flavor document root.
     */
    //@{
     ...
     */
    void
    flavor (::std::ostream& os,
            const ::openstack::xml::Flavor& x, 
     ...
     */
    void
    flavor (::xercesc::XMLFormatTarget& ft,
            const ::openstack::xml::Flavor& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
    ...
    flavor (const ::openstack::xml::Flavor& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);
    ...
    /**
     * @name Serialization functions for the %flavors document root.
     */
    //@{
     ...
     */
    void
    flavors (::std::ostream& os,
             const ::openstack::xml::Flavors& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
     ...
     */
    void
    flavors (::xercesc::XMLFormatTarget& ft,
             const ::openstack::xml::Flavors& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
     ...
     */
    ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
    flavors (const ::openstack::xml::Flavors& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
    ...
    void
    operator<< (::xercesc::DOMElement&, const Flavor&);

    void
    operator<< (::xercesc::DOMElement&, const Flavors&);
  }
}
